...
fun WeightScreen(
    ...
    var selectedWeight by remember { mutableStateOf(75f) }
    ...
    Box(
        ...
        Column(
            ...
            Column(
                ...
                Text(
                    ...
                    text = stringResource(R.string.setup_weight_title),
                ...
                Text(
                    text = stringResource(R.string.setup_weight_description),
                    color = MaterialTheme.colorScheme.onBackground,
        ...
        Box(
            ...
            AppOutlinedButton(
                ...
                viewModel.handleUiAction(SetUpAction.WeightEntered(selectedWeight))
            }
        }
    }
}
