...
val ValkyrieIcons.PlayOn: ImageVector
    get() {
        if (_Property1PlayOn != null) {
            return _Property1PlayOn!!
        }
        _Property1PlayOn = ImageVector.Builder(
            name = "Property1PlayOn",
            defaultWidth = 35.dp,
            defaultHeight = 35.dp,
            viewportWidth = 35f,
            viewportHeight = 35f
...
private var _Property1PlayOn: ImageVector? = null
