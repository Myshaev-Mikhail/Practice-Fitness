...
val ValkyrieIcons.CardioVariant: ImageVector
    get() {
        if (_CardioVariant != null) {
            return _CardioVariant!!
        }
        _CardioVariant = ImageVector.Builder(
            name = "CardioVariant",
            defaultWidth = 49.dp,
            defaultHeight = 42.dp,
            viewportWidth = 49f,
...
private var _CardioVariant: ImageVector? = null
