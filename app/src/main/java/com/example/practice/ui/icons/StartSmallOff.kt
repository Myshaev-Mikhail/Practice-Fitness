...
val ValkyrieIcons.StartSmallOff: ImageVector
    get() {
        if (_StartSmallOff != null) {
            return _StartSmallOff!!
        }
        _StartSmallOff = ImageVector.Builder(
            name = "StartSmallOff",
            defaultWidth = 15.dp,
            defaultHeight = 16.dp,
            viewportWidth = 15f,
...
private var _StartSmallOff: ImageVector? = null
